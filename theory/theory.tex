...
\end{align}
Fourier--Galerkin projection then transforms the argument to the real part operator
\begin{align*}
  \bbrack*{
    \omega^2 \wh \nabla^2 \otimes M
    + \omega \wh \nabla \otimes C
  ...
  = 0.
\end{align*}
We define $\wh A(\omega) \coloneq \bbrack*{
  \omega^2 \wh \nabla^2 \otimes M
  + \omega \wh \nabla \otimes C
  + I_{N_H + 1} \otimes K
}$
...
\begin{align}
  \wh \Rb(\wh \z)
  &\coloneq 2 \Re \bbrack*{\wh A(\omega) \wh \z
    + \wh \bb\ts{nl}
  - \wh \bb\ts{ext}} \\
  &= \wh A(\omega) \wh \z
  + \wh \bb\ts{nl}
  - \wh \bb\ts{ext}
  + \overline{\wh A(\omega) \wh \z
    + \wh \bb\ts{nl}
  - \wh \bb\ts{ext}}.
\end{align}
We need to compute
